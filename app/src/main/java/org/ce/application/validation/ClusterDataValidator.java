package org.ce.application.validation;
...
public class ClusterDataValidator {
    ...
    public static String diagnose(AllClusterData data) {
        ...
        if (result.isValid()) {
            sb.append("âœ“ All validations passed\n");
            sb.append("  Data is ready for CVM calculations.\n");
        } else {
            sb.append("âœ— Validation failed\n\n");
            ...
            if (!result.getWarnings().isEmpty()) {
                ...
                for (String warning : result.getWarnings()) {
                    sb.append("  âš  ").append(warning).append("\n");
                }
                sb.append("\n");
            }
        }
    ...
    public static class ValidationResult {
        ...
        public String getSummary() {
            if (isValid() && warnings.isEmpty()) {
                ...
                return "âœ“ Valid - " + warnings.size() + " warning(s)";
            } else {
                return "âœ— Invalid - " + errors.size() + " error(s)";
            }
        }
