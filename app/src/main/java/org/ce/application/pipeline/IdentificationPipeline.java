package org.ce.application.pipeline;
 ...
 * AllClusterData allData = IdentificationPipeline.identify(config);
 *
 * // Access results
 ...
 * @author  CVM Project
 * @version 2.0
 * @see     IdentificationRequest
 * @see     AllClusterData
 * @see     ClusterIdentifier
 * @see     CFIdentifier
 * @see     CMatrixBuilder
 */
public class IdentificationPipeline {

    private static final Logger LOG = LoggingConfig.getLogger(IdentificationPipeline.class);

    private IdentificationPipeline() {
     ...
     */
    public static AllClusterData identify(IdentificationRequest config) {
        ...
        LOG.fine("IdentificationPipeline.identify — ENTER: numComponents=" + config.getNumComponents());
        ...
        LOG.fine("IdentificationPipeline.identify — EXIT: tcdis=" + stage1Result.getTcdis()
