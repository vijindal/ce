 ...
 * @author  CVM Project
 * @version 2.0
 * @see     IdentificationPipeline
 * @see     org.ce.domain.model.data.AllClusterData
 */
public class IdentificationRequest {
    ...
    /**
     * Constructs a fully configured IdentificationRequest.
     *
     ...
     * @param transformationMatrix 3Ã—3 orientation matrix mapping disordered â†’ ordered
    ...
    /** @return the 3Ã—3 transformation matrix (row-major array) */
    ...
    /**
     * Creates a new builder for constructing a {@link IdentificationRequest}.
     *
    ...
    /**
     * Builder for {@link IdentificationRequest}.
     */
    public static class Builder {
        ...
        /** Set the transformation matrix (3Ã—3 array, row-major). */
        ...
        /** Build the {@link IdentificationRequest}. */
