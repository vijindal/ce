 ...
 * <ul>
 *   <li><b>Immutable:</b> Cluster data (Stages 1-3) from AllClusterData — fixed at creation</li>
 *   <li><b>Mutable:</b> System parameters (ECI) and macro parameters (T, x) — can change anytime</li>
...
public class CVMPhaseModel {
    ...
    private final ClusCoordListResult clusters; // Full cluster identification data

    private final org.ce.workbench.model.SystemIdentity system;
    ...
    /**
     * Factory creates a CVM phase model from calculation context.
     *
     * <p>Loads all cluster data (Stages 1-3) from AllClusterData.
     * User provides initial CEC, temperature, and composition values.
     * Performs first minimization on creation.
     *
     * @param context fully validated calculation context with AllClusterData
     ...
     * @throws IllegalArgumentException if context incomplete or parameters invalid
    ...
    public static CVMPhaseModel create(
        ...
        if (!allData.isComplete()) {
            throw new IllegalArgumentException("AllClusterData incomplete: " + allData.getCompletionStatus());
        }
    ...
    // =========================================================================
    // CONSTRUCTOR (Private — only called by factory)
    // =========================================================================

    /**
     * Private constructor. Extracts and caches all cluster data from AllClusterData.
     * Only called by the factory method.
     */
    private CVMPhaseModel(AllClusterData allData, org.ce.workbench.model.SystemIdentity system) {
    ...
    /**
     * Gets Helmholtz free energy F = H - T·S (alternative to G).
     */
    ...
    /**
     * Gets gradient norm ||∇G|| (convergence measure).
     */
    ...
    public org.ce.workbench.model.SystemIdentity getSystem() { return system; }
