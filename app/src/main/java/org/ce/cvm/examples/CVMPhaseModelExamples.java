...
public class CVMPhaseModelExamples {
    ...
    public static void example_SinglePoint() throws Exception {
        // Assume context and ECI are prepared
        CVMCalculationContext context = null; // Prepared elsewhere
    ...
    public static void example_TemperatureScan() throws Exception {
        CVMCalculationContext context = null;
        double[] eci = null;

        // Create model at initial condition
        CVMPhaseModel model = CVMPhaseModel.create(context, eci, 300.0, 0.5);
    ...
    public static void example_CompositionScan() throws Exception {
        ...
        CVMPhaseModel model = CVMPhaseModel.create(context, eci, 800.0, 0.0);
    ...
    public static void example_PhaseDiagram() throws Exception {
        ...
        CVMPhaseModel model = CVMPhaseModel.create(context, eci, temperatures[0], compositions[0]);
    ...
    public static void example_MultiComponent() throws Exception {
        CVMCalculationContext context = null; // Must be K=3 system
        double[] eci = null;

        // Create model for ternary system
        // Initial composition: x_A=0.5, x_B=0.3, x_C=0.2
        CVMPhaseModel model = CVMPhaseModel.create(context, eci, 800.0, 0.333);
    ...
    public static void example_CECInfluence() throws Exception {
        ...
        CVMPhaseModel model = CVMPhaseModel.create(context, eciBase, 800.0, 0.5);
    ...
    public static void example_FullStateExport() throws Exception {
        ...
        CVMPhaseModel model = CVMPhaseModel.create(context, eci, 600.0, 0.5);
        ...
        System.out.println("  S = " + String.format("%.6f", state.S) + " J/(mol·K)");
        System.out.println("\nConvergence:");
        System.out.println("  Iterations: " + state.iterations);
        System.out.println("  ||∇G||: " + String.format("%.2e", state.convergenceMeasure));
    ...
    public static void example_BatchProcessing() throws Exception {
        ...
        CVMPhaseModel model = CVMPhaseModel.create(context, eci, 300.0, 0.0);
    ...
    public static void example_AdaptiveSampling() throws Exception {
        ...
        CVMPhaseModel model = CVMPhaseModel.create(context, eci, 700.0, 0.5);
    ...
    // Note: These examples assume a prepared CVMCalculationContext and ECI array
