...
public final class NewtonRaphsonSolverSimple {
    ...
    /**
     * H = Σ_t msdis[t] · Σ_icf eci[icf] · u[icf]
     */
    ...
    /**
     * S = -R × Σ_t msdis[t] × kb[t] × Σ_j m[t][j] × Σ_v wcv[v] × cv[v] × ln(cv[v])
     */
    ...
    /**
     * Scu[icf] = -R × Σ_t msdis[t] × kb[t] × Σ_j m[t][j] × Σ_v wcv[v] × cmat[v][icf] × ln(cv[v])
     */
    ...
    /**
     * Scuu[icf1][icf2] = -R × Σ_t msdis[t] × kb[t] × Σ_j m[t][j] × Σ_v wcv[v] × cmat[v][icf1] × cmat[v][icf2] / cv[v]
     */
