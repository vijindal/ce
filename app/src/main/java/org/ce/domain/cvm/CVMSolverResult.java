...
public final class CVMSolverResult {
    ...
    private final double   gibbsEnergy;     // G = H âˆ’ TÂ·S at equilibrium
    ...
    public String toSummary() {
        ...
        sb.append("â•‘           CVM SOLVER RESULT                      â•‘\n");
        ...
        sb.append("  ||âˆ‡G||:         ").append(String.format("%.6e", gradientNorm)).append("\n");
        ...
        sb.append("  Entropy S:      ").append(String.format("%.8f", entropy)).append(" J/(molÂ·K)\n");
