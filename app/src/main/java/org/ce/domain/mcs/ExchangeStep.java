 ...
 * computes Î”E, and accepts or rejects via the Metropolis criterion.
 *
 ...
 * one site of species B (A â‰  B), chosen uniformly at random.</p>
 *
 * <h2>Acceptance criterion</h2>
 * <pre>
 *   P_accept = min(1, exp(âˆ’Î² Â· Î”E)),   Î² = 1/(k_B T)
 * </pre>
 *
 * @author  CE Project
 * @version 1.0
...
public class ExchangeStep {
    ...
    private final List<List<org.ce.domain.identification.geometry.Cluster>> orbits;
    private final double                                     beta;
    private final double                                     R;
    private final int                                        numComp;
    private final Random                                     rng;

    // Per-species cached site index lists â€” maintained incrementally
     ...
     *   <li>Compute Î”E via {@link LocalEnergyCalc#deltaEExchange}.</li>
