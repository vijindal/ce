 ...
 * from the {@code numComp âˆ’ 1} species different from the current one.</p>
 *
 * <h2>Chemical-potential correction</h2>
 * <p>The effective energy change includes a Î¼ correction:</p>
 * <pre>
 *   Î”E_total = Î”E_cluster + Î£_c  Î”Î¼[c] Â· Î”x[c]
 * </pre>
 * <p>where {@code Î”Î¼[c] = Î¼_c âˆ’ Î¼_0} (chemical potential of species c
 * relative to species 0), and {@code Î”x[c] = Â±1/N} depending on whether
...
public class FlipStep {
     ...
     * @param deltaMu chemical-potential differences {@code Î¼_c âˆ’ Î¼_0} in eV;
     ...
     *   <li>Pick a random new occupation {@code newOcc â‰  oldOcc}.</li>
     *   <li>Compute cluster Î”E via
     *       {@link LocalEnergyCalc#deltaESingleSite}.</li>
     *   <li>Add chemical-potential correction:
     *       {@code Î”E_Î¼ = (Î”Î¼[newOcc] âˆ’ Î”Î¼[oldOcc]) / N}.</li>
     *   <li>Accept with Metropolis probability and update in-place.</li>
     * </ol>
     *
     * @param config configuration to update in-place
     * @return Î”E if the move was accepted, 0.0 if rejected (energy unchanged)
     */
    public double attempt(LatticeConfig config) {
        ...
        // Chemical-potential correction: Î”x[newOcc] = +1/N, Î”x[oldOcc] = -1/N
