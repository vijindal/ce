 ...
 * For a BCC LÃ—LÃ—L supercell {@code N = 2Â·LÂ³}.</p>
 *
...
public class LatticeConfig {
     ...
     * {@code 0} (pure-A state).
     *
     * @param N       number of lattice sites; must be â‰¥ 1
     ...
     * {@code round(xFrac[c] Ã— N)}.  Sites are assigned by a partial
     * Fisher-Yates shuffle.  Species 0 fills any remaining sites after all
     * other species are placed.</p>
     *
     * @param xFrac composition fractions; must sum to â‰ˆ 1.0; length must equal
     *              {@code numComp}
    ...
    public void randomise(double[] xFrac, Random rng) {
        ...
        int placed = 0;
        // Assign species 1, 2, â€¦ (species 0 fills remainder)
