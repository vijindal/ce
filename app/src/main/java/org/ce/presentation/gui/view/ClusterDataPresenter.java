...
public final class ClusterDataPresenter {
     ...
     */
    /**
     * Overload without clusterKey â€” no storage path is shown.
     */
    ...
    public static void present(CFIdentificationJob job, String clusterKey, Consumer<String> logger) {
        ...
        try {
            ...
            if (allData == null) {
                logger.accept("âŒ ERROR: No cluster data available after job completion");
                return;
            }

            logger.accept("\nâœ“ CLUSTER DATA GENERATED SUCCESSFULLY");
            logger.accept("â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”");
            ...
            logger.accept("âŒ ERROR displaying cluster results: " + e.getMessage());
    ...
    private static void presentStoragePaths(String clusterKey, Consumer<String> log) {
        try {
            ...
            log.accept("â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€");
    ...
    private static void presentStage1(ClusterIdentificationResult stage1,
        ...
        if (stage1 == null) {
            log.accept("âŒ Stage 1 data is null!");
            return;
        }
        ...
        log.accept("âœ“ Stage 1 complete");
    }
    ...
    private static void presentStage2(CFIdentificationResult stage2,
        ...
        if (stage2 == null) {
            log.accept("âŒ Stage 2 data is null!");
            return;
        }
        ...
        log.accept("âœ“ Stage 2 complete");
    }
    ...
    private static void presentStage3(CMatrixResult cmatrixResult,
        ...
        if (cmatrixResult == null) {
            log.accept("âŒ Stage 3 data is null!");
            return;
        }
        ...
        log.accept("âœ“ Stage 3 complete");
    }
    ...
    private static void presentSummary(AllClusterData allData, Consumer<String> log) {
        ...
        log.accept("â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”");
        log.accept("âœ“ Cluster Types:       " + allData.getTcdis() + " (tcdis)");
        log.accept("âœ“ Correlation Funcs:   " + allData.getTcf() + " (tcf)");
        log.accept("âœ“ C-matrix Prepared:   Ready for CVM/MCS calculations");
        log.accept("âœ“ Computation Time:    " + allData.getComputationTimeMs() + " ms");
