 ...
 * - Primary axis (Left): Î”E per MC step (energy changes)
...
public class EnergyConvergenceChart extends VBox {
    ...
    private final NumberAxis yAxisPrimary;   // Î”E
    private final NumberAxis yAxisSecondary; // E_total
    
    private XYChart.Series<Number, Number> seriesDeltaEq;      // Î”E during equilibration
    private XYChart.Series<Number, Number> seriesDeltaAvg;     // Î”E during averaging
    ...
    public EnergyConvergenceChart() {
        ...
        yAxisPrimary.setLabel("Î”E (J/mol)");
        ...
        seriesDeltaEq.setName("Î”E (Equilibration)");
        
        seriesDeltaAvg = new XYChart.Series<>();
        seriesDeltaAvg.setName("Î”E (Averaging)");
    ...
    public List<ChartDataPoint> exportData() {
        ...
        // Collect all equilibration Î”E points
        ...
        // Collect all averaging Î”E points
