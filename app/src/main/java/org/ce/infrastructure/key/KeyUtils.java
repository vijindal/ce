package org.ce.infrastructure.key;
 ...
 * <p>Key terminology:</p>
 * <ul>
 *   <li><b>systemId</b>  â€” uniquely identifies a system instance
 *       ({@code "Ti-Nb_BCC_A2_T"})</li>
 *   <li><b>cecKey</b>    â€” element + model; one CEC file per alloy+model
 *       ({@code "Ti-Nb_BCC_A2_T"})</li>
 *   <li><b>clusterKey</b> â€” component-count + model; topology shared across
...
public final class KeyUtils {
     ...
     *
     * @param numComponents number of chemical components (2â€“5 typical)
