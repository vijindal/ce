 ...
 * <ol>
 *   <li>CEC database â€” element-keyed JSON files under
...
public class ECILoader {
    ...
    private static final Logger LOG = LoggingConfig.getLogger(ECILoader.class);
    ...
    // -------------------------------------------------------------------------
    // Database load (silent, typed result â€” Bug 7 fix)
    // -------------------------------------------------------------------------
    ...
    public static DBLoadResult loadECIFromDatabase(String elements, String structure,
                                                    ...
                                                    double temperature,
                                                    int requiredLength) {
        LOG.fine("[>>] loadECIFromDatabase key=" + elements
    ...
    /**
     * Attempts to load ECI data from the database only (legacy â€” no model qualifier).
     */
    public static DBLoadResult loadECIFromDatabase(String elements, int requiredLength) {
        LOG.fine("[>>] loadECIFromDatabase elements=" + elements
