 ...
 * @param gradientNorm   final gradient norm ||âˆ‡G|| at convergence
...
public record CVMMetadata(
     ...
     */
    public static CVMMetadata from(org.ce.domain.cvm.CVMSolverResult result, long wallClockTimeMs) {
