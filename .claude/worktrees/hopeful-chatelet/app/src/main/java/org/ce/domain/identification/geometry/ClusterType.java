package org.ce.domain.identification.geometry;
 ...
 *   <li>The full <em>orbit</em> â€” all symmetry-equivalent clusters.</li>
 *   <li>The <em>multiplicity</em> â€” the number of orbit members (equal to
 *       {@code orbit.size()}).</li>
 * </ul>
 *
 * @author  CVM Project
