 ...
 * <ul>
 *   <li>{@code clusterType} â€” which abstract cluster type (e.g. 2 = pair)</li>
 *   <li>{@code orbitMemberIndex} â€” which symmetry variant within that type</li>
 *   <li>{@code relativeVectors} â€” displacements of every site from the anchor
...
public class ClusterTemplate {
     ...
     * {@link org.ce.domain.identification.result.ClusCoordListResult#getClusCoordList()}.
     */
     ...
     *
     * @return array of length â‰¥ 1; {@code relativeVectors[0]} is {@code (0,0,0)}
     */
     ...
     *
     * @return {@code relativeVectors.length} â‰¥ 1
     */
     ...
     *   site count         : 2
     *   relative vectors:
     *     [0] (0.000000, 0.000000, 0.000000)  â† anchor
