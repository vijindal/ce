...
public class StructureModelMapping {
    ...
    static {
        ...
        // Phase â†’ Symmetry group name (without -SG suffix in keys, added in resolution)
        PHASE_TO_STRUCTURE_MAPPING.put("A1", "A1");    // FCC_A1 â†’ A1-SG
        PHASE_TO_STRUCTURE_MAPPING.put("A2", "A2");    // BCC_A2 â†’ A2-SG
        PHASE_TO_STRUCTURE_MAPPING.put("A3", "A3");    // HCP_A3 â†’ A3-SG
        PHASE_TO_STRUCTURE_MAPPING.put("B2", "B2");    // BCC_B2 â†’ B2-SG
        PHASE_TO_STRUCTURE_MAPPING.put("B3", "B3");    // ZnS structure â†’ B3-SG
        PHASE_TO_STRUCTURE_MAPPING.put("L1_2", "L1_2");  // FCC_L1_2 â†’ L1_2-SG
        PHASE_TO_STRUCTURE_MAPPING.put("L1_0", "L1_0");  // FCC_L1_0 â†’ L1_0-SG
        PHASE_TO_STRUCTURE_MAPPING.put("D0_22", "D0_22"); // BCC_D0_22 â†’ D0_22-SG
