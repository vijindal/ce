...
public class AllClusterData {
     ...
     *
     * @param moleFractions mole fractions (length = numComponents, Î£ = 1)
    ...
    public String getCompletionStatus() {
        ...
        if (isStage1Complete()) {
            sb.append("âœ“ tcdis=").append(stage1.getTcdis());
        } else {
            sb.append("âœ— Not computed");
        }
        sb.append("\n");

        sb.append("Stage 2 (CF ID):      ");
        if (isStage2Complete()) {
            sb.append("âœ“ tcf=").append(stage2.getTcf());
        } else {
            sb.append("âœ— Not computed");
        }
        sb.append("\n");
        ...
        sb.append("â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€\n");
        if (isComplete()) {
            sb.append("âœ“ COMPLETE - Ready for CVM\n");
            sb.append("Computed in: ").append(computationTimeMs).append(" ms");
        } else {
            sb.append("âœ— INCOMPLETE - Cannot run CVM\n");
