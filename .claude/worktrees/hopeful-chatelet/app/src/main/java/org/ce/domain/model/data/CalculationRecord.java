 ...
 * <pre>
 *   AllClusterData (prereqs) â†’ CVMSolverResult | MCResult (raw output) â†’ CalculationRecord (persistence)
 * </pre>
 *
 * <h2>Units</h2>
 * <ul>
...
public record CalculationRecord(
    ...
    public String summary() {
        return String.format(
            "%s @ T=%.1f K, x=%.3f: G=%.4f J/mol, H=%.4f J/mol, S=%.6f J/(molÂ·K)",
            method,
            temperature,
            compositionB(),
            gibbsEnergy,
    ...
    public static CalculationRecord fromCVM(
            ...
            double temperature,
            double[] composition,
            org.ce.domain.cvm.CVMSolverResult result,
            long wallClockMs) {
    ...
    public static CalculationRecord fromMCS(
            String id,
            String systemId,
            org.ce.domain.mcs.MCResult result,
            long wallClockMs) {
        
        // MCS provides energy per site; convert to J/mol
        // eV/site â†’ J/mol: multiply by N_A * e â‰ˆ 96485.3 (Faraday constant)
